...
export const detect = async (image: ImageBitmap, touchpadBox: TouchpadBox): Promise<GestureRecognizerResult> => {
  const gesture = recognizer.recognizeForVideo(image, Date.now());
